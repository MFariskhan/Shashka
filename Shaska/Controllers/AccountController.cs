...
namespace Shaska.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            var db = _context.Users.SingleOrDefault(c=> c.Email==model.Email);
            ...
            if (db == null && ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await UserManager.AddToRoleAsync(user.Id, "Rider");
                    */
                ...
                db.Birthday = model.Birthday;
                db.CellNumber = model.PhoneNumber;
