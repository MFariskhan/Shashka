...
AU.amazonS3Extender.prototype = {
	...
	m.addCustomField("x-amz-date", now_string + "T000000Z");
        ...
        if (this.checkIntegrity()) {
            m.enableStandardField("File[converterIndex]MD5_[itemIndex]", true);
            m.renameStandardField("File[converterIndex]MD5_[itemIndex]", "Content-MD5");
        }
